...
var require_createSuper = __commonJS({
  "node_modules/@babel/runtime/helpers/createSuper.js"(exports, module) {
    ...
    function _createSuper(t2) {
      var r2 = isNativeReflectConstruct();
      return function() {
        var e2, o2 = getPrototypeOf(t2);
        if (r2) {
          var s2 = getPrototypeOf(this).constructor;
          e2 = Reflect.construct(o2, arguments, s2);
        } else e2 = o2.apply(this, arguments);
        return possibleConstructorReturn(this, e2);
      };
    }
...
var require_SwipeableViews = __commonJS({
  "node_modules/react-swipeable-views/lib/SwipeableViews.js"(exports) {
    ...
    var SwipeableViews2 = function(_React$Component) {
      ...
      var _super = (0, _createSuper2.default)(SwipeableViews3);
...
// node_modules/@oliverlooney/react-brackets/dist/index.modern.js
...
var renderSeed = function renderSeed2(_ref) {
  ...
  var seed = _ref.seed, breakpoint = _ref.breakpoint, isMiddleOfTwoSided = _ref.isMiddleOfTwoSided;
...
var SingleElimination = function SingleElimination2(_ref) {
  ...
  var getFragment = function getFragment2(seed, roundIdx, idx, rounds2, isMiddleOfTwoSided) {
  ...
  var getRenderedRounds = function getRenderedRounds2(roundsStartIndex, roundsEndIndex, renderFirstHalfOfRoundsSeeds, rounds2, dir) {
    return rounds2.slice(roundsStartIndex, roundsEndIndex).map(function(round, roundIdx) {
      return import_react2.default.createElement(Round, {
        key: round.title,
        className: roundClassName,
        mobileBreakpoint
      }, round.title && roundTitleComponent(round.title, roundIdx), import_react2.default.createElement(SeedsList, {
        dir
      }, renderFirstHalfOfRoundsSeeds ? round.seeds.slice(0, round.seeds.length / 2).map(function(seed, idx) {
        return getFragment(seed, roundIdx, idx, rounds2, false);
      }) : round.seeds.slice(round.seeds.length / 2, round.seeds.length).map(function(seed, idx) {
        return getFragment(seed, roundIdx, idx, rounds2, roundIdx < roundsEndIndex - 2);
      })));
    });
  };
  if (twoSided) {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=@oliverlooney_react-brackets.js.map
